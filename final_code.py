...
class Score:
    def __init__(self):
        ...
        self.play_again_button = Button(self.score_frame,
                                        text="play again",
                                        font=("Arial", "20"),
                                        bg="blue",
                                        width=15, command=play_again)
        self.play_again_button.grid(row=2)
...
# Functions for the play again and export buttons
def play_again():
    score_tk.destroy()
    score = 0
    shuffle(questions)
